    ...
    <>  
      <header className={` ${sticky && 'fixed h-18 bg-linear-to-r to-cyan-500 from-blue-500 shadow-md ' } z-[9999] absolute top-0 max-w-7xl w-full justify-center lg:left-1/2 lg:-translate-x-1/2 `}>
        <div className='text-white font-semibold text-sm w-[95%] mx-auto flex justify-between items-center py-1'>
          <span>
            <Link to={'/'}>
              <img src="src/assets/NNF-Logo.png" className='h-16'/>
            </Link>
          </span>
        ...
        <div className={`${mobileMenu ? 'left-0' : 'left-[-100%]'} fixed top-0 bottom-0 w-[100%] bg-red-400 z-50 transition-all duration-300 ease-in-out p-4 lg:hidden overflow-auto`}>
          ...
          <span className='inline-flex gap-1 '>
            <img src="src/assets/NNF-Logo.png" className='h-12 border-e-2 pe-1 border-gray-600'/>
            <img src="src/assets/NEOCON-Logo.png" className='h-12'/>
          </span>
          </div>
